...
#include "p_interfaces/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = p_interfaces::msg::Num;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const p_interfaces::msg::Num *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<p_interfaces::msg::Num *>(
    untyped_ros_message);
...
{
  return &p_interfaces::msg::typesupport_fastrtps_cpp::_Num__handle;
}
